...
//////////////////////////////////////
	...
	if(yaw0 < -2.62 || pitch1 < -1.1 || pitch2 < 0.2 || yaw3 < -2.97 || pitch4 < -1.66 || yaw5 < -2.97|| yaw0 > 2.62 || pitch1 > 1.75 || pitch2 > 2.44 || yaw3 > 2.97 || pitch4 > 2.36 || yaw5 > 2.97){
		z = 0;
	}
	for(int ii = 0; ii < 6; ii++){
	if(msg->transforms[ii].transform.rotation.x == 0 && msg->transforms[ii].transform.rotation.y == 0 &&msg->transforms[ii].transform.rotation.z == 0 &&msg->transforms[ii].transform.rotation.w == 0){
		z = 0;
	}
	}
